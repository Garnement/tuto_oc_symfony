...
class Advert
{
    ...
    */
    private $image;
     ...
     /**
     * @ORM\OneToMany(targetEntity="OC\PlatformBundle\Entity\Application", mappedBy="advert", cascade={"persist"})
     * @Assert\Valid()
     */
    ...
    */
    ...
    public function __construct()
    {
        ...
        // on doit la définir dans le constructeur:
    ...
    {
        // Utilisation d'une méthode d'arraycollection pour supprimer la category en argument
